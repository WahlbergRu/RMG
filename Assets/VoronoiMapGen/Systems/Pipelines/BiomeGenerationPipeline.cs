...
namespace VoronoiMapGen.Systems
{
    public static class BiomeGenerationPipeline
    {
        ...
        {
            NativeList<Entity> level1Cells = CellQueryHelper.GetLevel1Cells(em);
            ...
            int maxSiteIndex = CellQueryHelper.FindMaxSiteIndex(em, DetailLevel.Regional);
            if (maxSiteIndex < 0)
            {
            ...
            using BiomeGenerationContext biomeContext = new BiomeGenerationContext(em, settings, level1Cells, maxSiteIndex);
