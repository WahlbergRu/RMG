...
namespace VoronoiMapGen.Utils
{
    public class UnifiedResourceManager : MonoBehaviour
    {
        ...
        private struct DeadItem { public Object obj; public int dieTime; }
        private Queue<DeadItem> _graveyard = new Queue<DeadItem>();
        ...
        public static UnifiedResourceManager Instance
        {
            get
            {
                ...
                if (_instance == null)
                {
                    ...
                    _instance = Object.FindFirstObjectByType<UnifiedResourceManager>();
                    #else
        ...
        public static UnifiedResourceManager TryGetInstance()
        {
            ...
            #if UNITY_2023_1_OR_NEWER
            return Object.FindFirstObjectByType<UnifiedResourceManager>();
            #else
