...
public partial class MapGraph
{
    ...
    public class MapNode
    {
        ...
        public float extraRainfall = 0;
        public float heat = 0;
        public float precipitation = 0;
        public Boolean oceanCell = false;
        ...
        {
            return string.Format("{0}: {1}, heat: {2}, precipitation: {3}, humidity: {4}", base.ToString(), centerPoint, heat, precipitation, humidity);
        }
    }
}